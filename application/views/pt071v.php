			...
			<div class="panel-body">
				<div class="form-row">
                     <div class="form-group col-md-12">
						<label class="form-control-label">ID Rencana Pola Tanam*</label>
					...
					<div class="form-group col-md-12 jedaobyek">
						<label class="form-control-label" style="margin-bottom: -5px;">Komoditas Tanaman</label>
...
<script>
	...
	function tambah(){
        ...
        $.ajax({
            ...
            method: "POST",
            data: {id: id, nop: nop, mt: mt, tgl: tgl, komoditas: komoditas},
            cache: "false",
            success: function(x){
				swal.close();
				var y = atob(x);
