			...
			<div class="panel-body">
				<div class="form-row">
					<div class="form-group col-md-12">
						<label class="form-control-label">ID Petugas Pendamping*</label>
					...
					<div class="form-group col-md-12 jedaobyek">
						...
						<input type="text" class="form-control khusus_abjad jedaobyek" id="txt_petugas" placeholder="Masukkan Nama BPP" autocomplete="off">
					</div>
					<div class="form-group col-md-12 jedaobyek">
...
<script>
	...
	function tambah() {
		...
		var id = $("#txtid").val();
		var petugas = $("#txt_petugas").val();
		var jumlah = $("#txt_jumlah").val();
		var kec = $("#txt_id_kec").val();
		var ipwkec = $("#txt_id_ipwkec").val();
		var tahun = $("#txt_tahun").val();

		if (id == "" || petugas == "" || jumlah == "" || tahun == "" || kec == "" || ipwkec == "") {
			swal({
				title: 'Tambah Gagal',
