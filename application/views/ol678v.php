<div class="page-header">
	<h1 class="page-title">Pengelolaan Data Olah Lahan</h1>
			...
			<div class="panel-body">
				<div class="form-row">
                     <div class="form-group col-md-12">
						<label class="form-control-label">ID Olah Lahan*</label>
					...
					<div class="form-group col-md-12 jedaobyek">
						<label class="form-control-label" style="margin-bottom: -5px;">ID Lahan*</label>
					...
					<div class="form-group col-md-12 jedaobyek">
						<label class="form-control-label">Tanggal Singkal I*</label>
						<input type="date" class="form-control khusus_abjad jedaobyek" id="txttgl1" autocomplete="off">
					</div>
					<div class="form-group col-md-12 jedaobyek">
						<label class="form-control-label">Tanggal Singkal II*</label>
						<input type="date" class="form-control khusus_abjad jedaobyek" id="txttgl2" autocomplete="off">
					</div>
					<div class="form-group col-md-12 jedaobyek">
						<label class="form-control-label">Tanggal Garu*</label>
						<input type="date" class="form-control khusus_abjad jedaobyek" id="txttgl3" autocomplete="off">
					</div>
					<div class="form-group col-md-12 jedaobyek">
						<label class="form-control-label" style="margin-bottom: -5px;">Jenis Tanah*</label>
						<select class="form-control select2" id="cbotan">
							<option value="">Silahkan Pilih</option>
							<option value="Dominan Pasir">Dominan Pasir</option>
							<option value="Dominan Debu">Dominan Debu</option>
							<option value="Dominan Liat">Dominan Liat</option>
						</select>
					</div>
...
<script>
	...
	function tambah(){
        ...
        var tgl_singkal1 = $("#txttgl1").val();
        var tgl_singkal2 = $("#txttgl2").val();
        var tgl_garuh = $("#txttgl3").val();
        var tanah = $("#cbotan").val();
		
        if(id == "" || lahan == "" || tgl_singkal1 == "" || tgl_singkal2 == "" || tgl_garuh == "" || tanah == ""){
        ...
        $.ajax({
            ...
            method: "POST",
            data: {id: id, lahan: lahan, tgl_singkal1: tgl_singkal1, tgl_singkal2: tgl_singkal2, tgl_garuh: tgl_garuh, tanah: tanah.toString()},
            cache: "false",
            success: function(x){
				swal.close();
				var y = atob(x);
                if(y == 1){
                    swal({
						...
						text: 'Data Olah Lahan Berhasil di Tambahkan',
						icon: 'success'
					}).then((Refreshh)=>{
						refresh();
						tabel.ajax.reload(null, false);
	...
	function update(){
        ...
        $.ajax({
            ...
            method: "POST",
           data: {id: id, lahan: lahan, tgl_singkal1: tgl_singkal1, tgl_singkal2: tgl_singkal2, tgl_garuh: tgl_garuh, tanah: tanah},
            cache: "false",
            success: function(x){
				swal.close();
				var y = atob(x);
                if(y == 1){
                    swal({
						...
						text: 'Data Olah Lahan Berhasil di Update',
						icon: 'success'
					}).then((Refreshh)=>{
						refresh();
						tabel.ajax.reload(null, false);
					...
					success: function(x){
						...
						if(y == 1){
							swal({
								...
								text: 'Data Olah Lahan Berhasil di Hapus',
								icon: 'success'
							}).then((Refreshh)=>{
								refresh();
								tabel.ajax.reload(null, false);
