<div class="page-header">
	<h1 class="page-title">Pengelolaan Data Poktan</h1>
			...
			<div class="panel-body">
				<div class="form-row">
                     <div class="form-group col-md-12">
						<label class="form-control-label">ID Poktan*</label>
					...
					<div class="form-group col-md-12 jedaobyek">
						...
						<input type="text" class="form-control khusus_abjad jedaobyek" id="txtnama" placeholder="Masukkan Nama Gapoktan" autocomplete="off" maxlength="100">
					</div>
					<div class="form-group col-md-12 jedaobyek">
						<label class="form-control-label">Tanggal Berdiri*</label>
						<input type="date" class="form-control khusus_abjad jedaobyek" id="txttgl" placeholder="Masukkan Tanggal" autocomplete="off" maxlength="100">
					</div>
					<div class="form-group col-md-12 jedaobyek">
						<label class="form-control-label">Nomor Legalitas*</label>
						<input type="text" class="form-control jedaobyek" id="txtno" placeholder="Masukkan No Legalitas" autocomplete="off" maxlength="100">
					</div>
					<div class="form-group col-md-12 jedaobyek">
						<label class="form-control-label" style="margin-bottom: -5px;">Status</label>
						<select class="form-control" id="cbost">
					...
					<div class="form-group col-md-12 jedaobyek">
						...
						<select class="form-control select2" id="cbogp">
					...
					<div class="form-group col-md-12 jedaobyek">
						...
						<input type="text" class="form-control khusus_abjad jedaobyek" id="txttelp" placeholder="Masukkan Nomor Telp" autocomplete="off" maxlength="100">
					</div>
					<div class="form-group col-md-12 jedaobyek">
...
<script>
	...
	function tambah(){
        ...
        var nama = $("#txtnama").val();
       	var tgl = $("#txttgl").val();
        var no = $("#txtno").val();
        var status = $("#cbost").val();
        var alamat = $("#txtalamat").val();
		var gp = $("#cbogp").val();
		var telp = $("#txttelp").val();
		var email = $("#txtemail").val();
		
         if(id == "" || nama == "" || tgl == "" || no == ""|| status == "" || alamat == "" || gp == ""|| telp == "" || email == "" ){
        ...
        $.ajax({
            ...
            method: "POST",
           	data: {id: id, nama: nama, tgl: tgl, no: no, status: status, alamat: alamat, gp: gp, telp: telp, email: email},
            cache: "false",
            success: function(x){
				swal.close();
				var y = atob(x);
                if(y == 1){
                    swal({
						...
						text: 'Data Poktan Berhasil di Tambahkan',
						icon: 'success'
					}).then((Refreshh)=>{
						refresh();
						tabel.ajax.reload(null, false);
            ...
            success: function(x){
                ...
                if(y == 1){
                    swal({
						...
						text: 'Data Poktan Berhasil di Update',
						icon: 'success'
					}).then((Refreshh)=>{
						refresh();
						tabel.ajax.reload(null, false);
					...
					success: function(x){
						...
						if(y == 1){
							swal({
								...
								text: 'Data Poktan Berhasil di Hapus',
								icon: 'success'
							}).then((Refreshh)=>{
								refresh();
								tabel.ajax.reload(null, false);
		...
		$.ajax({
            ...
            success: function(x){
				...
				if(xx[0] == 1){
			        ...
			        $("#txttgl").val(xx[3]);
			        $("#txtno").val(xx[4]);
			        $("#cbost").val(xx[5]).change();
			        $("#txtalamat").val(xx[6]);
					$("#cbogp").val(xx[7]).change();
					$("#txttelp").val(xx[8]);
					$("#txtemail").val(xx[9]);
