<div class="page-header">
	<h1 class="page-title">Pengelolaan Data Komoditas Tanaman</h1>
			...
			<div class="panel-body">
				<div class="form-row">
                     <div class="form-group col-md-12">
						<label class="form-control-label">ID Komoditas Tanaman*</label>
					...
					<div class="form-group col-md-12 jedaobyek">
						<label class="form-control-label" style="margin-bottom: -5px;">Jenis Tanaman</label>
					...
					<div class="form-group col-md-12 jedaobyek">
						<label class="form-control-label">Nama Komoditas*</label>
						<input type="text" class="form-control khusus_abjad jedaobyek" id="txtnama" placeholder="Masukkan Nama Komoditas" autocomplete="off">
					</div>
					<div class="form-group col-md-12 jedaobyek">
						<label class="form-control-label">Lama Tanam*</label>
						<input type="text" class="form-control khusus_abjad jedaobyek" id="txtlama" placeholder="Masukkan Lama Tanam" autocomplete="off">
					</div>
...
<script>
	...
	function tambah(){
        ...
        var lama_tanam = $("#txtlama").val();
		
        if(id == "" || komoditas == "" || nama == "" || lama_tanam == ""){
        ...
        $.ajax({
            ...
            method: "POST",
            data: {id: id, komoditas: komoditas,nama: nama, lama_tanam: lama_tanam},
            cache: "false",
            success: function(x){
				swal.close();
				var y = atob(x);
                if(y == 1){
                    swal({
						...
						text: 'Data Komoditas Tanaman Berhasil di Tambahkan',
						icon: 'success'
					}).then((Refreshh)=>{
						refresh();
						tabel.ajax.reload(null, false);
            ...
            success: function(x){
                ...
                if(y == 1){
                    swal({
						...
						text: 'Data Komoditas Tanaman Berhasil di Update',
						icon: 'success'
					}).then((Refreshh)=>{
						refresh();
						tabel.ajax.reload(null, false);
					...
					success: function(x){
						...
						if(y == 1){
							swal({
								...
								text: 'Data Komoditas Tanaman Berhasil di Hapus',
								icon: 'success'
							}).then((Refreshh)=>{
								refresh();
								tabel.ajax.reload(null, false);
