							...
							<div class="panel">
								<div class="panel-body">
									<div class="form-row">
										...
										<div class="form-group col-md-12 jedaobyek">
											<label class="form-control-label" style="margin-bottom: -5px;">Desa</label>
											<select class="form-control select2" id="cbodesae" multiple="multiple"></select>
										</div>
										<div class="form-group col-md-12 jedaobyek">
											<label class="form-control-label">Kode Pos*</label>
	...
	function filter(el){
		...
		$.ajax({
	        ...
	        $("#txtseke").val(xx[12]);
					...
					$("#txtptte").val(xx[14]);
	        $("#cboptae").val(xx[15]).change();
	        $("#txtalae").val(xx[16]);
	        // $("#cbodesae").val(xx[17]).change();
					$("#txtpose").val(xx[18]);
					$("#txttelpe").val(xx[19]);
					$("#txtemae").val(xx[20]);
					$("#cbostae").val(xx[21]).change();
					$("#cbojjte").val(xx[22]).change();
					$("#cbojjae").val(xx[23]).change();
					$("#cbojabe").val(xx[24]).change();
					...
					');
					sessionStorage.setItem("pilihdesa", xx[17]);
				}else{
