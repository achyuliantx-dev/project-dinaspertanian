<div class="page-header">
	<h1 class="page-title">Pengelolaan Data Relasi Asosiasi</h1>
			...
			<div class="panel-body">
				<div class="form-row">
                     <div class="form-group col-md-12">
						<label class="form-control-label">ID Relasi Asosiasi*</label>
					...
					<div class="form-group col-md-12 jedaobyek">
						...
						<select class="form-control select2" id="cboakec">
							<option value="">Silahkan Pilih</option>
							<?php
								if(is_array($dtakec)){
									if(count($dtakec)>0){
...
<script>
	...
	function tambah(){
        ...
        $.ajax({
            ...
            method: "POST",
            data: {id: id, akab: akab, akec: akec},
            cache: "false",
            success: function(x){
				swal.close();
				var y = atob(x);
                if(y == 1){
                    swal({
						...
						text: 'Data Relasi Asosiasi Berhasil di Tambahkan',
						icon: 'success'
					}).then((Refreshh)=>{
						refresh();
						tabel.ajax.reload(null, false);
            ...
            success: function(x){
                ...
                if(y == 1){
                    swal({
						...
						text: 'Data Relasi Asosiasi Berhasil di Update',
						icon: 'success'
					}).then((Refreshh)=>{
						refresh();
						tabel.ajax.reload(null, false);
					...
					success: function(x){
						...
						if(y == 1){
							swal({
								...
								text: 'Data Relasi Asosiasi Berhasil di Hapus',
								icon: 'success'
							}).then((Refreshh)=>{
								refresh();
								tabel.ajax.reload(null, false);
