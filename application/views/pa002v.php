<div class="page-header">
	<h1 class="page-title">Pengelolaan Data Pengurus Asosiasi Kabupaten</h1>
			...
			<div class="panel-body">
				<div class="form-row">
                    <div class="form-group col-md-12">
						<label class="form-control-label">ID Pengurus Asosiasi Kabupaten*</label>
					...
					<div class="form-group col-md-12 jedaobyek">
						<label class="form-control-label" style="margin-bottom: -5px;">Asosiasi Kabupaten</label>
						<select class="form-control select2" id="cboakab">
					...
					<div class="form-group col-md-12 jedaobyek">
						<label class="form-control-label">Ketua*</label>
						<input type="text" class="form-control khusus_abjad jedaobyek" id="txtket" placeholder="Masukkan Nama Ketua" autocomplete="off" maxlength="100">
					</div>
					<div class="form-group col-md-12 jedaobyek">
						<label class="form-control-label">Sekretaris*</label>
						<input type="text" class="form-control khusus_abjad jedaobyek" id="txtsek" placeholder="Masukkan Nama Sekretaris" autocomplete="off" maxlength="100">
					</div>
					<div class="form-group col-md-12 jedaobyek">
						<label class="form-control-label">Bendahara*</label>
						<input type="text" class="form-control khusus_abjad jedaobyek" id="txtben" placeholder="Masukkan Nama Bendahara" autocomplete="off" maxlength="100">
					</div>
					<div class="form-group col-md-12 jedaobyek">
						<label class="form-control-label">Periode Awal*</label>
						<input type="date" class="form-control khusus_abjad jedaobyek" id="txttgl1" placeholder="Masukkan Periode Awal" autocomplete="off" maxlength="100">
					</div>
					<div class="form-group col-md-12 jedaobyek">
						<label class="form-control-label">Periode Akhir*</label>
						<input type="date" class="form-control khusus_abjad jedaobyek" id="txttgl" placeholder="Masukkan Periode Akhir" autocomplete="off" maxlength="100">
					</div>
...
<script>
	...
	function tambah(){
        ...
        var id = $("#txtid").val();
        var akab = $("#cboakab").val();
        var ket = $("#txtket").val();
        var sek = $("#txtsek").val();
        var ben = $("#txtben").val();
        var pawal = $("#txttgl1").val();
		var pakhir = $("#txttgl").val();
        if(id == "" || akab == "" || ket == "" || sek == ""|| ben == "" || pawal == "" || pakhir == ""){
        ...
        $.ajax({
            ...
            method: "POST",
            data:  {id: id, akab: akab, ket: ket, sek: sek, ben: ben, pawal: pakhir, pakhir: pakhir},
            cache: "false",
            success: function(x){
				swal.close();
				var y = atob(x);
                if(y == 1){
                    swal({
						...
						text: 'Data Pengurus Asosiasi Kabupaten Berhasil di Tambahkan',
						icon: 'success'
					}).then((Refreshh)=>{
						refresh();
						tabel.ajax.reload(null, false);
	...
	function update(){
        ...
        $.ajax({
            ...
            method: "POST",
            data: {id: id, akab: akab, ket: ket, sek: sek, ben: ben, pawal: pawal, pakhir: pakhir},
            cache: "false",
            success: function(x){
				swal.close();
				var y = atob(x);
                if(y == 1){
                    swal({
						...
						text: 'Data Pengurus Asosiasi Kabupaten Berhasil di Update',
						icon: 'success'
					}).then((Refreshh)=>{
						refresh();
						tabel.ajax.reload(null, false);
					...
					success: function(x){
						...
						if(y == 1){
							swal({
								...
								text: 'Data Pengurus Asosiasi Kabupaten Berhasil di Hapus',
								icon: 'success'
							}).then((Refreshh)=>{
								refresh();
								tabel.ajax.reload(null, false);
