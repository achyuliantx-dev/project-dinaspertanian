<div class="page-header">
	<h1 class="page-title">Pengelolaan Data Curah Hujan</h1>
			...
			<div class="panel-body">
				<div class="form-row">
					<div class="form-group col-md-12">
						<label class="form-control-label">ID Curah Hujan*</label>
					...
					<div class="form-group col-md-12 jedaobyek">
						<label class="form-control-label" style="margin-bottom: -5px;">Bulan</label>
						<select class="form-control select2" id="cbobul">
					...
					<div class="form-group col-md-12 jedaobyek">
						<label class="form-control-label">Curah Hujan*</label>
						<input type="text" class="form-control khusus_abjad jedaobyek" id="txtch" placeholder="Masukkan Curah Hujan" autocomplete="off" maxlength="100">
					</div>
					<div class="form-group col-md-12 jedaobyek">
						<label class="form-control-label">Hari Hujan*</label>
						<input type="text" class="form-control khusus_abjad jedaobyek" id="txthh" placeholder="Masukkan Hari Hujan" autocomplete="off" maxlength="100">
					</div>
					<div class="form-group col-md-12 jedaobyek">
						<label class="form-control-label" style="margin-bottom: -5px;">Tahun Anggran</label>
			...
			success: function(x) {
				...
				if (y == 1) {
					swal({
						...
						text: 'Data Curah Hujan Berhasil di Tambahkan',
						icon: 'success'
					}).then((Refreshh) => {
						refresh();
						tabel.ajax.reload(null, false);
			...
			success: function(x) {
				...
				if (y == 1) {
					swal({
						...
						text: 'Data Curah Hujan Berhasil di Update',
						icon: 'success'
					}).then((Refreshh) => {
						refresh();
						tabel.ajax.reload(null, false);
					...
					success: function(x) {
						...
						if (y == 1) {
							swal({
								...
								text: 'Data Curah Hujan Berhasil di Hapus',
								icon: 'success'
							}).then((Refreshh) => {
								refresh();
								tabel.ajax.reload(null, false);
	...
	function filter(el) {
		...
		$.ajax({
			...
			success: function(x) {
				...
				if (xx[0] == 1) {
					$("#txtid").val(xx[1]);
					$("#cbobul").val(xx[2]).change();
					$("#txtch").val(xx[3]);
					$("#txthh").val(xx[4]);
					$("#cbota").val(xx[5]).change();
					$("#cbokec").val(xx[6]).change();
