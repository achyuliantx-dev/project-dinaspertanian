Poktan<div class="page-header">
	<h1 class="page-title">Pengelolaan Data Pengurus Poktan</h1>
			...
			<div class="panel-body">
				<div class="form-row">
                    <div class="form-group col-md-12">
						<label class="form-control-label">ID Pengurus Poktan*</label>
					...
					<div class="form-group col-md-12 jedaobyek">
						...
						<select class="form-control select2" id="cbopok">
...
<script>
	...
	function tambah(){
        ...
        if(id == "" || pok == "" || ket == "" || sek == ""|| ben == "" || pawal == "" || pakhir == ""){
        ...
        $.ajax({
            ...
            method: "POST",
            data:  {id: id, pok: pok, ket: ket, sek: sek, ben: ben, pawal: pakhir, pakhir: pakhir},
            cache: "false",
            success: function(x){
				swal.close();
				var y = atob(x);
                if(y == 1){
                    swal({
						...
						text: 'Data Pengurus Poktan Berhasil di Tambahkan',
						icon: 'success'
					}).then((Refreshh)=>{
						refresh();
						tabel.ajax.reload(null, false);
	...
	function update(){
        ...
        $.ajax({
            ...
            method: "POST",
            data: {id: id, pok: pok, ket: ket, sek: sek, ben: ben, pawal: pawal, pakhir: pakhir},
            cache: "false",
            success: function(x){
				swal.close();
				var y = atob(x);
                if(y == 1){
                    swal({
						...
						text: 'Data Pengurus Poktan Berhasil di Update',
						icon: 'success'
					}).then((Refreshh)=>{
						refresh();
						tabel.ajax.reload(null, false);
					...
					success: function(x){
						...
						if(y == 1){
							swal({
								...
								text: 'Data Pengurus Poktan Berhasil di Hapus',
								icon: 'success'
							}).then((Refreshh)=>{
								refresh();
								tabel.ajax.reload(null, false);
