<div class="page-header">
	<h1 class="page-title">Pengelolaan Data Rincian Bulanan</h1>
			...
			<div class="panel-body">
				<div class="form-row">
					<div class="form-group col-md-12">
						<label class="form-control-label">ID Rincian Bulanan*</label>
					...
					<div class="form-group col-md-12 jedaobyek">
						...
						<input type="text" class="form-control khusus_abjad jedaobyek" id="txt_target" placeholder="Masukkan Nama BPP" autocomplete="off">
					</div>
					<div class="form-group col-md-12 jedaobyek">
					...
					<div class="form-group col-md-12 jedaobyek">
						<label class="form-control-label">Realisasi*</label>
						<input type="text" class="form-control khusus_abjad jedaobyek" id="txt_realisasi" placeholder="Masukkan Alamat" autocomplete="off">
					</div>
					<div class="form-group col-md-12 jedaobyek">
						<label class="form-control-label">Bulan Ke*</label>
						<input type="text" class="form-control khusus_abjad jedaobyek" id="txt_bulan_ke" placeholder="Masukkan Alamat" autocomplete="off">
					</div>
					<div class="form-group col-md-12 jedaobyek">
					...
					<div class="form-group col-md-12 jedaobyek">
						...
						<input type="text" class="form-control khusus_abjad jedaobyek" id="txt_triwulan" placeholder="Masukkan Alamat" autocomplete="off">
					</div>
					<div class="form-group col-md-12 jedaobyek">
			...
			success: function(x) {
				...
				if (y == 1) {
					swal({
						...
						text: 'Data Rincian Bulanan Berhasil di Tambahkan',
						icon: 'success'
					}).then((Refreshh) => {
						refresh();
						tabel.ajax.reload(null, false);
			...
			success: function(x) {
				...
				if (y == 1) {
					swal({
						...
						text: 'Data Rincian Bulanan Berhasil di Update',
						icon: 'success'
					}).then((Refreshh) => {
						refresh();
						tabel.ajax.reload(null, false);
					...
					success: function(x) {
						...
						if (y == 1) {
							swal({
								...
								text: 'Data Rincian Bulanan Berhasil di Hapus',
								icon: 'success'
							}).then((Refreshh) => {
								refresh();
								tabel.ajax.reload(null, false);
		...
		$.ajax({
			...
			success: function(x) {
				...
				if (xx[0] == 1) {
					...
					$("#txt_target").val(xx[2]);
					$("#txt_nip").val(xx[3]);
					$("#txt_realisasi").val(xx[4]);
					$("#txt_bulan_ke").val(xx[5]);
					$("#txt_tahun").val(xx[6]);
					$("#txt_kode_jenjang").val(xx[7]).change();
					$("#txt_triwulan").val(xx[8]);
					$("#txt_no_urut_rencana").val(xx[9]);
					$("#txt_pangkat_gol_asli").val(xx[10]);
