<div class="page-header">
	<h1 class="page-title">Pengelolaan Data Pengurus Gapoktan</h1>
			...
			<div class="panel-body">
				<div class="form-row">
                     <div class="form-group col-md-12">
						<label class="form-control-label">ID Pengurus Gapoktan*</label>
					...
					<div class="form-group col-md-12 jedaobyek">
						<label class="form-control-label" style="margin-bottom: -5px;">Gapoktan</label>
						<select class="form-control select2" id="cbogap">
...
<script>
	...
	function tambah(){
        ...
        if(id == "" || gap == "" || ket == "" || sek == ""|| ben == "" || tgl1 == "" || tgl == ""){
        ...
        $.ajax({
            ...
            method: "POST",
            data: {id: id, gap: gap, ket: ket, sek: sek, ben: ben, tgl1: tgl1, tgl: tgl},
            cache: "false",
            success: function(x){
				swal.close();
				var y = atob(x);
                if(y == 1){
                    swal({
						...
						text: 'Data Pengurus Gapoktan Berhasil di Tambahkan',
						icon: 'success'
					}).then((Refreshh)=>{
						refresh();
						tabel.ajax.reload(null, false);
            ...
            success: function(x){
                ...
                if(y == 1){
                    swal({
						...
						text: 'Data Pengurus Gapoktan Berhasil di Update',
						icon: 'success'
					}).then((Refreshh)=>{
						refresh();
						tabel.ajax.reload(null, false);
