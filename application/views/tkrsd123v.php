<div class="page-header">
	<h1 class="page-title">Pengelolaan Data SDM Desa</h1>
			...
			<div class="panel-body">
				<div class="form-row">
					<div class="form-group col-md-12">
						<label class="form-control-label">ID SDM Desa*</label>
					...
					<div class="form-group col-md-12 jedaobyek">
						...
						<input type="text" class="form-control khusus_abjad jedaobyek" id="txt_jenis_klasifikasi" placeholder="Masukkan Alamat" autocomplete="off">
					</div>
					<div class="form-group col-md-12 jedaobyek">
						<label class="form-control-label" style="margin-bottom: -5px;">Jenis Kelamin*</label>
						<select class="form-control select2" id="txt_jenis_kelamin">
					...
					<div class="form-group col-md-12 jedaobyek">
						...
						<input type="text" class="form-control khusus_abjad jedaobyek" id="txt_umur" placeholder="Masukkan Alamat" autocomplete="off">
					</div>
					<div class="form-group col-md-12 jedaobyek">
						<label class="form-control-label">Mata Pencarian*</label>
						<input type="text" class="form-control khusus_abjad jedaobyek" id="txt_mata_pencarian" placeholder="Masukkan Alamat" autocomplete="off">
					</div>
					<div class="form-group col-md-12 jedaobyek">
						<label class="form-control-label">Kriteria*</label>
						<input type="text" class="form-control khusus_abjad jedaobyek" id="txt_kriteria" placeholder="Masukkan Alamat" autocomplete="off">
					</div>
					<div class="form-group col-md-12 jedaobyek">
...
<script>
	...
	function refresh() {
		...
		$("#txt_no_urut").val("");
		$("#txt_jenis_klasifikasi").val("");
		$("#txt_jenis_kelamin").val("").change();
		$("#txt_umur").val("");
		$("#txt_mata_pencarian").val("");
		$("#txt_kriteria").val("");
		$("#txt_jumlah").val("");
		$("#txt_tahun").val("");
	...
	function tambah() {
		...
		var jenis_klasifikasi = $("#txt_jenis_klasifikasi").val();
		var jenis_kelamin = $("#txt_jenis_kelamin").val();
		var umur = $("#txt_umur").val();
		var mata_pencarian = $("#txt_mata_pencarian").val();
		var kriteria = $("#txt_kriteria").val();
		...
		if (no_urut == "" || jenis_klasifikasi == "" || jenis_kelamin == "" || umur == "" || mata_pencarian == "" || kriteria == "" || jumlah == "" || tahun == "" || id_desa == "" || id_kecamatan == "" || id_ipwdes == "") {
			swal({
				title: 'Tambah Gagal',
			...
			success: function(x) {
				...
				if (y == 1) {
					swal({
						...
						text: 'Data SDM Desa Berhasil di Tambahkan',
						icon: 'success'
					}).then((Refreshh) => {
						refresh();
						tabel.ajax.reload(null, false);
			...
			success: function(x) {
				...
				if (y == 1) {
					swal({
						...
						text: 'Data SDM Desa Berhasil di Update',
						icon: 'success'
					}).then((Refreshh) => {
						refresh();
						tabel.ajax.reload(null, false);
					...
					success: function(x) {
						...
						if (y == 1) {
							swal({
								...
								text: 'Data SDM Desa Berhasil di Hapus',
								icon: 'success'
							}).then((Refreshh) => {
								refresh();
								tabel.ajax.reload(null, false);
		...
		$.ajax({
			...
			success: function(x) {
				...
				if (xx[0] == 1) {
					...
					$("#txt_jenis_klasifikasi").val(xx[3]);
					$("#txt_jenis_kelamin").val(xx[4]).change();
					$("#txt_umur").val(xx[5]);
					$("#txt_mata_pencarian").val(xx[6]);
					$("#txt_kriteria").val(xx[7]);
					$("#txt_jumlah").val(xx[8]);
					$("#txt_tahun").val(xx[9]);
					$("#txt_id_desa").val(xx[10]).change();
					$("#txt_id_kecamatan").val(xx[11]).change();
					$("#txt_id_ipwdes").val(xx[12]).change();
