<div class="page-header">
	<h1 class="page-title">Pengelolaan Data Gerakan Penerapan Teknologi</h1>
			...
			<div class="panel-body">
				<div class="form-row">
					<div class="form-group col-md-12">
						<label class="form-control-label">ID Gerakan Penerapan Teknologi*</label>
					...
					<div class="form-group col-md-12 jedaobyek">
						...
						<input type="text" class="form-control khusus_abjad jedaobyek" id="txtur" placeholder="Masukkan Uraian" autocomplete="off">
					</div>
					<div class="form-group col-md-12 jedaobyek">
						<label class="form-control-label">Jumlah*</label>
						<input type="text" class="form-control khusus_abjad jedaobyek" id="txtjml" placeholder="Masukkan Jumlah" autocomplete="off">
					</div>
					<div class="form-group col-md-12 jedaobyek">
			...
			success: function(x) {
				...
				if (y == 1) {
					swal({
						...
						text: 'Data Gerakan Penerapan Teknologi Berhasil di Tambahkan',
						icon: 'success'
					}).then((Refreshh) => {
						refresh();
						tabel.ajax.reload(null, false);
			...
			success: function(x) {
				...
				if (y == 1) {
					swal({
						...
						text: 'Data Gerakan Penerapan Teknologi Berhasil di Update',
						icon: 'success'
					}).then((Refreshh) => {
						refresh();
						tabel.ajax.reload(null, false);
					...
					success: function(x) {
						...
						if (y == 1) {
							swal({
								...
								text: 'Data Gerakan Penerapan Teknologi Berhasil di Hapus',
								icon: 'success'
							}).then((Refreshh) => {
								refresh();
								tabel.ajax.reload(null, false);
