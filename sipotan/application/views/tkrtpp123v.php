<div class="page-header">
	<h1 class="page-title">Pengelolaan Data Tingkat Pendidikan Pendudukan</h1>
			...
			<div class="panel-body">
				<div class="form-row">
					<div class="form-group col-md-12">
						<label class="form-control-label">ID Tingkat Pendidikan Pendudukan*</label>
					...
					<div class="form-group col-md-12 jedaobyek">
						<label class="form-control-label" style="margin-bottom: -5px;">Tingkat Pendidikan*</label>
						<select class="form-control select2" id="txt_tingkat_pendidikan">
							<option value="">Silahkan Pilih</option>
							<option value="Pendudukan tidak tamat SD/sederajat">Pendudukan tidak tamat SD/sederajat</option>
							<option value="Pendudukan tamat SD/sederajat">Pendudukan tamat SD/sederajat</option>
							<option value="Pendudukan tamat SLTP/sederajat">Pendudukan tamat SLTP/sederajat</option>
							<option value="Pendudukan tamat SLTA/sederajat">Pendudukan tamat SLTA/sederajat</option>
							<option value="Pendudukan tamat Diploma/sederajat">Pendudukan tamat Diploma/sederajat</option>
							<option value="Pendudukan tamat S1, S2, S3">Pendudukan tamat S1, S2, S3</option>
...
<script>
	...
	function refresh() {
		...
		$("#txt_no_urut").val("");
		$("#txt_tingkat_pendidikan").val("").change();
		$("#txt_jumlah").val("");
		$("#txt_tahun").val("");
			...
			success: function(x) {
				...
				if (y == 1) {
					swal({
						...
						text: 'Data Tingkat Pendidikan Pendudukan Berhasil di Tambahkan',
						icon: 'success'
					}).then((Refreshh) => {
						refresh();
						tabel.ajax.reload(null, false);
			...
			success: function(x) {
				...
				if (y == 1) {
					swal({
						...
						text: 'Data Tingkat Pendidikan Pendudukan Berhasil di Update',
						icon: 'success'
					}).then((Refreshh) => {
						refresh();
						tabel.ajax.reload(null, false);
					...
					success: function(x) {
						...
						if (y == 1) {
							swal({
								...
								text: 'Data Tingkat Pendidikan Pendudukan Berhasil di Hapus',
								icon: 'success'
							}).then((Refreshh) => {
								refresh();
								tabel.ajax.reload(null, false);
		...
		$.ajax({
			...
			success: function(x) {
				...
				if (xx[0] == 1) {
					...
					$("#txt_tingkat_pendidikan").val(xx[3]).change();
					$("#txt_jumlah").val(xx[4]);
					$("#txt_tahun").val(xx[5]);
					$("#txt_id_kecamatan").val(xx[6]).change();
					$("#txt_id_ipwkec").val(xx[7]).change();
