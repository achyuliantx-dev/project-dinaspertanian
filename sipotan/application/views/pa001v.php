<div class="page-header">
	<h1 class="page-title">Pengelolaan Data Pengurus Asosiasi Kecamatan</h1>
			...
			<div class="panel-body">
				<div class="form-row">
                     <div class="form-group col-md-12">
						<label class="form-control-label">ID Pengurus Asosiasi Kecamatan*</label>
					...
					<div class="form-group col-md-12 jedaobyek">
						<label class="form-control-label" style="margin-bottom: -5px;">Asosiasi Kecamatan</label>
...
<script>
	...
	function tambah(){
        ...
        var sek = $("#txtsek").val();
        var ben = $("#txtben").val();
        var tgl1 = $("#txttgl1").val();
		var tgl = $("#txttgl").val();
		    
        if(id == "" || kec == "" || ket == "" || sek == ""|| ben == "" || tgl1 == "" || tgl == ""){
        ...
        $.ajax({
            ...
            method: "POST",
            data: {id: id, kec: kec, ket: ket, sek: sek, ben: ben, tgl1: tgl1, tgl: tgl},
            cache: "false",
            success: function(x){
				swal.close();
				var y = atob(x);
                if(y == 1){
                    swal({
						...
						text: 'Data Pengaturan Asosiasi Kecamatan Berhasil di Tambahkan',
						icon: 'success'
					}).then((Refreshh)=>{
						refresh();
						tabel.ajax.reload(null, false);
            ...
            success: function(x){
                ...
                if(y == 1){
                    swal({
						...
						text: 'Data Pengurus Asosiasi Kecamatan Berhasil di Update',
						icon: 'success'
					}).then((Refreshh)=>{
						refresh();
						tabel.ajax.reload(null, false);
	...
	function hapus(){
        ...
        if(id == ""){
            swal({title: 'Hapus Gagal', text: 'ID Pengurus Asosiasi Kecamatan Kosong !', icon: 'error'});
            return;
		}
		swal("Memproses Data.....", {button: false, closeOnClickOutside: false, closeOnEsc: false});
		swal({
					...
					success: function(x){
						...
						if(y == 1){
							swal({
								...
								text: 'Data Pengurus Asosiasi Kecamatan Berhasil di Hapus',
								icon: 'success'
							}).then((Refreshh)=>{
								refresh();
								tabel.ajax.reload(null, false);
