...
<html class="no-js css-menubar" lang="en">
    <head>
        ...
        <link rel="stylesheet" href="<?= base_url('assets/examples/css/layouts/headers.css'); ?>">
        <link rel="stylesheet" href="<?= base_url('global/vendor/datatables.net-bs4/dataTables.bootstrap4.css'); ?>">
        <link rel="stylesheet" href="<?= base_url('global/vendor/select2/select2.min.css'); ?>">
        ...
        <script src="<?= base_url('global/vendor/select2/select2.min.js'); ?>"></script>
        <!-- <script src="<?= base_url('global/js/Plugin/bootstrap-select.js'); ?>"></script> -->
        <script src="<?= base_url('assets/examples/js/forms/advanced.js'); ?>"></script>
    ...
    <body class="animsition site-navbar-small dashboard">
        <nav class="site-navbar navbar navbar-default navbar-fixed-top navbar-mega navbar-inverse" role="navigation">
            <div class="navbar-header">
                ...
                <a class="navbar-brand navbar-brand-center" href="index.html">
                    <img class="navbar-brand-logo navbar-brand-logo-normal" src="<?= base_url('assets/images/pemda.png'); ?>" title="SIPOTAN">
                    <img class="navbar-brand-logo navbar-brand-logo-special" src="<?= base_url('assets/images/pemda.png'); ?>" title="SIPOTAN">
                    <span class="navbar-brand-text hidden-xs-down"> SIPOTAN</span>
                </a>
            </div>
            ...
            <div class="site-menubar-body">
                <div>
                    <ul class="site-menu" data-plugin="menu">
                        ...
                        <li class="dropdown site-menu-item has-sub" id="tpmdashboard">
                            <a href="<?= base_url($ids.'/Dashboard'); ?>">
                        ...
                        <?php
                            if(is_array($datamenu)){
                                foreach($datamenu as $x){
                                    $idm = $x->id_menu;
                                    $menu = $x->menu;
                                    $icmenu = $x->icon_menu;
                                    echo '
                                        <li class="dropdown site-menu-item has-sub" id="tpm'.$idm.'">
                                            <a data-toggle="dropdown" href="javascript:void(0)" data-dropdown-toggle="false">
                                                <i class="site-menu-icon '.$icmenu.'" aria-hidden="true"></i>
                                                ...
                                                <div class="site-menu-scroll-wrap is-list">
                                                    <div>
                                                        ...
                                                        if(is_array($dataform)){
                                                            foreach($dataform as $y){
                                                                $idme = $y->id_menu;
                                                                $iform = ucfirst($y->id_form);
                                                                $form = ucwords($y->nama_form);
                                                                $icform = $y->icon_form;
                                                                if(isset($idf)){
                                                                    if($idf == $y->id_form){$idmskr = $idme;}
                                                                }
                                                                if($idme == $idm){
                                                                    echo '
                                                                        <li class="site-menu-item" id="stpm'.$iform.'">
                                                                            <a class="animsition-link" href="'.base_url($iform).'">
                                                                                <i class="site-menu-icon '.$icform.'" aria-hidden="true"></i>
        ...
        <div class="page">
            <div class="page-content">
                <?php 
					if($fill == "d500"){include $fill.".php";}
					else{include APPPATH."views\\".$fill.".php";}
				?>
            </div>
        </div>
        ...
        <footer class="site-footer">
            <div class="site-footer-legal">© 2022 <a href="javascript:void(0)">SIPOTAN</a></div>
