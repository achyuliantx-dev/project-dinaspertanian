<div class="page-header">
	<h1 class="page-title">Pengelolaan Data Ekosistem</h1>
			...
			<div class="panel-body">
				<div class="form-row">
                     <div class="form-group col-md-12">
						<label class="form-control-label">ID Ekosistem*</label>
					...
					<div class="form-group col-md-12 jedaobyek">
						<label class="form-control-label" style="margin-bottom: -5px;">Jenis OPT</label>
					...
					<div class="form-group col-md-12 jedaobyek">
						...
						<input type="text" class="form-control khusus_abjad jedaobyek" id="txttl" placeholder="Masukkan Tindak Lanjut" autocomplete="off">
					</div>
					<div class="form-group col-md-12 jedaobyek">
						<label class="form-control-label">Hasil Tindak Lanjut *</label>
						<input type="text" class="form-control khusus_abjad jedaobyek" id="txthtl" placeholder="Masukkan Hasil Tindak Lanjut" autocomplete="off">
					</div>
...
<script>
	...
	function tambah(){
        ...
        $.ajax({
            ...
            method: "POST",
            data: {id: id, id_lahan: id_lahan, jo: jo, tl: tl, htl: htl},
            cache: "false",
            success: function(x){
				swal.close();
				var y = atob(x);
                if(y == 1){
                    swal({
						...
						text: 'Data Ekosistem Berhasil di Tambahkan',
						icon: 'success'
					}).then((Refreshh)=>{
						refresh();
						tabel.ajax.reload(null, false);
            ...
            success: function(x){
                ...
                if(y == 1){
                    swal({
						...
						text: 'Data Ekosistem Berhasil di Update',
						icon: 'success'
					}).then((Refreshh)=>{
						refresh();
						tabel.ajax.reload(null, false);
