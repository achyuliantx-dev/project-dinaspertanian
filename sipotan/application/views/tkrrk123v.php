<div class="page-header">
	<h1 class="page-title">Pengelolaan Data Realisasi Kegiatan</h1>
				...
				<table class="table table-hover table-striped w-full" id="tbl-xdt">
					<thead>
						<tr>
							...
							<th>No Urut Relasi</th>
							<th>Tanggal Relasi</th>
							<th>Penjelasan</th>
							<th>Alternatif</th>
							<th>Bukti Fisik</th>
							<th>Is TPP</th>
			...
			<div class="panel-body">
				<div class="form-row">
					<div class="form-group col-md-12">
						<label class="form-control-label">ID Realisasi Kegiatan*</label>
					...
					<div class="form-group col-md-12 jedaobyek">
						<label class="form-control-label">Bulan Ke*</label>
						<input type="text" class="form-control khusus_abjad jedaobyek" id="txt_bulan_ke" placeholder="Masukkan Nama BPP" autocomplete="off">
					</div>
					<div class="form-group col-md-12 jedaobyek">
					...
					<div class="form-group col-md-12 jedaobyek">
						<label class="form-control-label">No Urut Relasi*</label>
						<input type="text" class="form-control khusus_abjad jedaobyek" id="txt_no_urut_relasi" placeholder="Masukkan Alamat" autocomplete="off">
					</div>
					<div class="form-group col-md-12 jedaobyek">
						<label class="form-control-label">Tanggal Relasi*</label>
						<input type="date" class="form-control khusus_abjad jedaobyek" id="txt_tanggal_relasi" autocomplete="off">
					</div>

					<div class="form-group col-md-12 jedaobyek">
						<label class="form-control-label">Penjelasan*</label>
						<input type="text" class="form-control khusus_abjad jedaobyek" id="txt_penjelasan" placeholder="Masukkan Alamat" autocomplete="off">
					</div>

					<div class="form-group col-md-12 jedaobyek">
						<label class="form-control-label">Alternatif*</label>
						<input type="text" class="form-control khusus_abjad jedaobyek" id="txt_alternatif" placeholder="Masukkan Alamat" autocomplete="off">
					</div>

					<div class="form-group col-md-12 jedaobyek">
						<label class="form-control-label">Bukti Fisik*</label>
						<input type="text" class="form-control khusus_abjad jedaobyek" id="txt_bukti_fisik" placeholder="Masukkan Alamat" autocomplete="off">
					</div>

					<div class="form-group col-md-12 jedaobyek">
						<label class="form-control-label">Is TPP*</label>
						<input type="text" class="form-control khusus_abjad jedaobyek" id="txt_is_tpp" placeholder="Masukkan Alamat" autocomplete="off">
					</div>
...
<script>
	...
	function refresh() {
		...
		$("#txt_no_urut_relasi").val("");
		$("#txt_tanggal_relasi").val("");
		$("#txt_penjelasan").val("");
		$("#txt_alternatif").val("");
		$("#txt_bukti_fisik").val("");
		$("#txt_is_tpp").val("");
	...
	function tambah() {
		...
		var no_urut_relasi = $("#txt_no_urut_relasi").val();
		var tanggal_relasi = $("#txt_tanggal_relasi").val();
		var penjelasan = $("#txt_penjelasan").val();
		var alternatif = $("#txt_alternatif").val();
		var bukti_fisik = $("#txt_bukti_fisik").val();
		var is_tpp = $("#txt_is_tpp").val();



		if (id == "" || bulan_ke == "" || tahun == "" || nip == "" || kode_jenjang == "" || no_urut_rencana == "" || pangkat_gol_asli == "" || no_urut_relasi == "" || tanggal_relasi == "" || penjelasan == "" || alternatif == "" || bukti_fisik == "" || is_tpp == "") {
			swal({
				title: 'Tambah Gagal',
		...
		$.ajax({
			...
			data: {
				...
				no_urut_relasi: no_urut_relasi,
				tanggal_relasi: tanggal_relasi,
			...
			success: function(x) {
				...
				if (y == 1) {
					swal({
						...
						text: 'Data Realisasi Kegiatan Berhasil di Tambahkan',
						icon: 'success'
					}).then((Refreshh) => {
						refresh();
						tabel.ajax.reload(null, false);
			...
			success: function(x) {
				...
				if (y == 1) {
					swal({
						...
						text: 'Data Realisasi Kegiatan Berhasil di Update',
						icon: 'success'
					}).then((Refreshh) => {
						refresh();
						tabel.ajax.reload(null, false);
					...
					success: function(x) {
						...
						if (y == 1) {
							swal({
								...
								text: 'Data Realisasi Kegiatan Berhasil di Hapus',
								icon: 'success'
							}).then((Refreshh) => {
								refresh();
								tabel.ajax.reload(null, false);
		...
		$.ajax({
			...
			success: function(x) {
				...
				if (xx[0] == 1) {
					...
					$("#txtid").val(xx[1]);
					$("#txt_bulan_ke").val(xx[2]);
					$("#txt_tahun").val(xx[3]);
					$("#txt_nip").val(xx[4]);
					$("#txt_kode_jenjang").val(xx[5]).change();
					$("#txt_no_urut_rencana").val(xx[6]);
					$("#txt_pangkat_gol_asli").val(xx[7]);
					$("#txt_no_urut_relasi").val(xx[8]);
					$("#txt_tanggal_relasi").val(xx[9]);
					$("#txt_penjelasan").val(xx[10]);
					$("#txt_alternatif").val(xx[11]);
					$("#txt_bukti_fisik").val(xx[12]);
					$("#txt_is_tpp").val(xx[13]);
