<div class="page-header">
	<h1 class="page-title">Pengelolaan Data Asosiasi Kecamatan</h1>
			...
			<div class="panel-body">
				<div class="form-row">
                     <div class="form-group col-md-12">
						<label class="form-control-label">ID Asosiasi Kecamatan*</label>
					...
					<div class="form-group col-md-12 jedaobyek">
						...
						<input type="text" class="form-control khusus_abjad jedaobyek" id="txtnama" placeholder="Masukkan Nama Asosiasi Kecamatan" autocomplete="off" maxlength="100">
					</div>
					<div class="form-group col-md-12 jedaobyek">
					...
					<div class="form-group col-md-12 jedaobyek">
						...
						<select class="form-control select2" id="cbost">
...
<script>
	...
	function tambah(){
        ...
        if(id == "" || nama == "" || tgl == "" || no == ""|| stat == "" || alamat == "" || kec == ""|| telp == "" || email == "" ){
        ...
        $.ajax({
            ...
            method: "POST",
            data: {id: id, nama: nama, tgl: tgl, no: no, stat: stat, alamat: alamat, kec: kec, telp: telp, email: email},
            cache: "false",
            success: function(x){
				swal.close();
				var y = atob(x);
                if(y == 1){
                    swal({
						...
						text: 'Data Asosiasi Kecamatan Berhasil di Tambahkan',
						icon: 'success'
					}).then((Refreshh)=>{
						refresh();
						tabel.ajax.reload(null, false);
            ...
            success: function(x){
                ...
                if(y == 1){
                    swal({
						...
						text: 'Data Asosiasi Kecamatan Berhasil di Update',
						icon: 'success'
					}).then((Refreshh)=>{
						refresh();
						tabel.ajax.reload(null, false);
					...
					success: function(x){
						...
						if(y == 1){
							swal({
								...
								text: 'Data Asosiasi Kecamatan Berhasil di Hapus',
								icon: 'success'
							}).then((Refreshh)=>{
								refresh();
								tabel.ajax.reload(null, false);
