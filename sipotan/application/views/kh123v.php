<div class="page-header">
	<h1 class="page-title">Pengelolaan Data Kandungan Unsur Hara</h1>
			...
			<div class="panel-body">
				<div class="form-row">
                     <div class="form-group col-md-12">
						<label class="form-control-label">ID Kandungan Unsur Hara*</label>
					...
					<div class="form-group col-md-12 jedaobyek">
						<label class="form-control-label">Nilai n *</label>
						<input type="text" class="form-control khusus_abjad jedaobyek" id="nilai_n" placeholder="Masukkan Nilai n" autocomplete="off">
					</div>
					<div class="form-group col-md-12 jedaobyek">
						<label class="form-control-label">Nilai p *</label>
						<input type="text" class="form-control khusus_abjad jedaobyek" id="nilai_p" placeholder="Masukkan Nilai p" autocomplete="off">
					</div>
					<div class="form-group col-md-12 jedaobyek">
						<label class="form-control-label">Nilai k *</label>
						<input type="text" class="form-control khusus_abjad jedaobyek" id="nilai_k" placeholder="Masukkan Nilai k" autocomplete="off">
					</div>
					<div class="form-group col-md-12 jedaobyek">
						<label class="form-control-label">Nilai Ph *</label>
						<input type="text" class="form-control khusus_abjad jedaobyek" id="ph" placeholder="Masukkan Nilai Ph" autocomplete="off">
					</div>
...
<script>
	...
	function tambah(){
        ...
        var nilai_n = $("#nilai_n").val();
        var nilai_p = $("#nilai_p").val();
        var nilai_k = $("#nilai_k").val();
        var ph = $("#ph").val();
		
        if(id == "" || id_lahan == "" || nilai_n == "" || nilai_p == "" || nilai_k == "" || ph == ""){
        ...
        $.ajax({
            ...
            method: "POST",
            data: {id: id, id_lahan: id_lahan, nilai_n: nilai_n, nilai_p: nilai_p, nilai_k: nilai_k, ph: ph},
            cache: "false",
            success: function(x){
				swal.close();
				var y = atob(x);
                if(y == 1){
                    swal({
						...
						text: 'Data Kandungan Unsur Hara Berhasil di Tambahkan',
						icon: 'success'
					}).then((Refreshh)=>{
						refresh();
						tabel.ajax.reload(null, false);
            ...
            success: function(x){
                ...
                if(y == 1){
                    swal({
						...
						text: 'Data Kandunan Unsur Hara Berhasil di Update',
						icon: 'success'
					}).then((Refreshh)=>{
						refresh();
						tabel.ajax.reload(null, false);
					...
					success: function(x){
						...
						if(y == 1){
							swal({
								...
								text: 'Data Kandungan Unsur Hara Berhasil di Hapus',
								icon: 'success'
							}).then((Refreshh)=>{
								refresh();
								tabel.ajax.reload(null, false);
