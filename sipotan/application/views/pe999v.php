<div class="page-header">
	<h1 class="page-title">Pengelolaan Data Pengamatan</h1>
		...
		<div class="panel">
			...
			<div class="panel-body">
				<div class="form-row">
					...
					<div class="form-group col-md-12 jedaobyek">
						<label class="form-control-label">Pengamatan Ke-*</label>
						<select class="form-control select2" id="cbope">
							<option value="">Silahkan Pilih</option>
					...
					<div class="form-group col-md-12 jedaobyek">
						<label class="form-control-label">Tanaman Ke-*</label>
						<select class="form-control select2" id="cbota">
							<option value="">Silahkan Pilih</option>
							<option value="1">1</option>
							<option value="2">2</option>
							<option value="3">3</option>
					...
					<div class="form-group col-md-12 jedaobyek">
						<label class="form-control-label">Jumlah Anakan*</label>
						<input type="text" class="form-control khusus_abjad jedaobyek" id="txtan" placeholder="Masukkan Jumlah Anakan" autocomplete="off">
					</div>
					<div class="form-group col-md-12 jedaobyek">
						<label class="form-control-label">Tinggi Tanaman*</label>
						<input type="text" class="form-control khusus_abjad jedaobyek" id="txtti" placeholder="Masukkan Tinggi Tanaman" autocomplete="off">
					</div>
					<div class="form-group col-md-12 jedaobyek">
						<label class="form-control-label">Jumlah Malai*</label>
						<input type="text" class="form-control khusus_abjad jedaobyek" id="txtma" placeholder="Masukkan Jumlah Malai" autocomplete="off">
					</div>
					<div class="form-group col-md-12 jedaobyek">
						<label class="form-control-label">Rerata Gabah Malai*</label>
						<input type="text" class="form-control khusus_abjad jedaobyek" id="txtre" placeholder="Masukkan Rerata Gabah Malai" autocomplete="off">
					</div>
...
<script>
	...
	function tambah(){
        ...
        var pengamatan = $("#cbope").val();
        var tanaman = $("#cbota").val();
        var anakan = $("#txtan").val();
        var tinggiTan = $("#txtti").val();
        var malai = $("#txtma").val();
        var rerata = $("#txtre").val();
		
        if(id == "" || lahan == "" || pengamatan == "" || tanaman == "" || anakan == "" || tinggiTan == "" || malai == "" || rerata == "" ){
        ...
        $.ajax({
            ...
            method: "POST",
            data: {id: id, lahan: lahan,pengamatan: pengamatan, tanaman: tanaman, anakan: anakan, tinggiTan: tinggiTan, malai: malai, rerata: rerata},
            cache: "false",
            success: function(x){
				swal.close();
				var y = atob(x);
                if(y == 1){
                    swal({
						...
						text: 'Data Pengamatan Berhasil di Tambahkan',
						icon: 'success'
					}).then((Refreshh)=>{
						refresh();
						tabel.ajax.reload(null, false);
            ...
            success: function(x){
                ...
                if(y == 1){
                    swal({
						...
						text: 'Data Pengamatan Berhasil di Update',
						icon: 'success'
					}).then((Refreshh)=>{
						refresh();
						tabel.ajax.reload(null, false);
					...
					success: function(x){
						...
						if(y == 1){
							swal({
								...
								text: 'Data Pengamatan Berhasil di Hapus',
								icon: 'success'
							}).then((Refreshh)=>{
								refresh();
								tabel.ajax.reload(null, false);
		...
		$.ajax({
            ...
            success: function(x){
				...
				if(xx[0] == 1){
					...
					$("#cbope").val(xx[3]).change();
					$("#cbota").val(xx[4]).change();
					$("#txtan").val(xx[5]).change();
					$("#txtti").val(xx[6]).change();
					$("#txtma").val(xx[7]).change();
					$("#txtre").val(xx[8]).change();
