<div class="page-header">
	<h1 class="page-title">Pengelolaan Data Petugas Pendamping</h1>
			...
			<div class="panel-body">
				<div class="form-row">
					<div class="form-group col-md-12">
						<label class="form-control-label">ID Jenis Tanaman Pendamping*</label>
					...
					<div class="form-group col-md-12 jedaobyek">
						...
						<input type="text" class="form-control khusus_abjad jedaobyek" id="txt_jenis_tanaman" placeholder="Masukkan Nama BPP" autocomplete="off">
					</div>
					<div class="form-group col-md-12 jedaobyek">
						<label class="form-control-label">Luas Tanam*</label>
						<input type="text" class="form-control khusus_abjad jedaobyek" id="txt_luas_tanam" placeholder="Masukkan Alamat" autocomplete="off">
					</div>
					<div class="form-group col-md-12 jedaobyek">
						<label class="form-control-label">Luas Panen*</label>
						<input type="text" class="form-control khusus_abjad jedaobyek" id="txt_luas_panen" placeholder="Masukkan Alamat" autocomplete="off">
					</div>
					<div class="form-group col-md-12 jedaobyek">
						<label class="form-control-label">Produksi*</label>
						<input type="text" class="form-control khusus_abjad jedaobyek" id="txt_produksi" placeholder="Masukkan Alamat" autocomplete="off">
					</div>
					<div class="form-group col-md-12 jedaobyek">
						<label class="form-control-label">Produktivitas*</label>
						<input type="text" class="form-control khusus_abjad jedaobyek" id="txt_produktivitas" placeholder="Masukkan Alamat" autocomplete="off">
					</div>
					<div class="form-group col-md-12 jedaobyek">
					...
					<div class="form-group col-md-12 jedaobyek">
						...
						<input type="text" class="form-control khusus_abjad jedaobyek" id="txt_nama_tanaman" placeholder="Masukkan Alamat" autocomplete="off">
					</div>
...
<script>
	...
	function tambah() {
		...
		var id = $("#txtid").val();
		var jenis_tanaman = $("#txt_jenis_tanaman").val();
		var luas_tanam = $("#txt_luas_tanam").val();
		var luas_panen = $("#txt_luas_panen").val();
		var produksi = $("#txt_produksi").val();
		var produktivitas = $("#txt_produktivitas").val();
		var tahun = $("#txt_tahun").val();
		var id_des = $("#txt_id_des").val();
		var id_kec = $("#txt_id_kec").val();
		var id_tkr_kode_ipwdes = $("#txt_id_ipwdes").val();
		var nama_tanaman = $("#txt_nama_tanaman").val();


		if (id == "" || jenis_tanaman == "" || luas_tanam == "" || luas_panen == "" || produksi == "" || produktivitas == "" || tahun == "" || id_des == "" || id_kec == "" || id_tkr_kode_ipwdes == "" || nama_tanaman == "") {
			swal({
				title: 'Tambah Gagal',
			...
			success: function(x) {
				...
				if (y == 1) {
					swal({
						...
						text: 'Data Petugas Pendamping Berhasil di Tambahkan',
						icon: 'success'
					}).then((Refreshh) => {
						refresh();
						tabel.ajax.reload(null, false);
			...
			success: function(x) {
				...
				if (y == 1) {
					swal({
						...
						text: 'Data Petugas Pendamping Berhasil di Update',
						icon: 'success'
					}).then((Refreshh) => {
						refresh();
						tabel.ajax.reload(null, false);
					...
					success: function(x) {
						...
						if (y == 1) {
							swal({
								...
								text: 'Data Petugas Pendamping Berhasil di Hapus',
								icon: 'success'
							}).then((Refreshh) => {
								refresh();
								tabel.ajax.reload(null, false);
	...
	function filter(el) {
		...
		$.ajax({
			...
			success: function(x) {
				...
				if (xx[0] == 1) {
					$("#txtid").val(xx[1]);
					$("#txt_jenis_tanaman").val(xx[2]);
					$("#txt_luas_tanam").val(xx[3]);
					$("#txt_luas_panen").val(xx[4]);
					$("#txt_produksi").val(xx[5]);
					$("#txt_produktivitas").val(xx[6]);
					$("#txt_tahun").val(xx[7]);
					$("#txt_id_des").val(xx[8]).change();
					$("#txt_id_kec").val(xx[9]).change();
					$("#txt_id_ipwdes").val(xx[10]).change();
					$("#txt_nama_tanaman").val(xx[11]);
