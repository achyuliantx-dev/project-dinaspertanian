<div class="page-header">
	<h1 class="page-title">Pengelolaan Data Pertanian Desa</h1>
			...
			<div class="panel-body">
				<div class="form-row">
					<div class="form-group col-md-12">
						<label class="form-control-label">ID Pertanian Desa*</label>
					...
					<div class="form-group col-md-12 jedaobyek">
						<label class="form-control-label">Kode Lahan*</label>
						<input type="text" class="form-control khusus_abjad jedaobyek" id="txt_kode_lahan" placeholder="Masukkan Nama BPP" autocomplete="off">
					</div>
					<div class="form-group col-md-12 jedaobyek">
						<label class="form-control-label">Jenis Pertanian*</label>
						<input type="text" class="form-control khusus_abjad jedaobyek" id="txt_jenis_pertanian" placeholder="Masukkan Alamat" autocomplete="off">
					</div>
					<div class="form-group col-md-12 jedaobyek">
						<label class="form-control-label">Luas Jumlah*</label>
						<input type="text" class="form-control khusus_abjad jedaobyek" id="txt_luas_jumlah" placeholder="Masukkan Alamat" autocomplete="off">
					</div>
					<div class="form-group col-md-12 jedaobyek">
					...
					<div class="form-group col-md-12 jedaobyek">
						...
						<input type="text" class="form-control khusus_abjad jedaobyek" id="txt_uraian" placeholder="Masukkan Alamat" autocomplete="off">
					</div>
					<div class="form-group col-md-12 jedaobyek">
...
<script>
	...
	function tambah() {
		...
		var id = $("#txtid").val();
		var kode_lahan = $("#txt_kode_lahan").val();
		var jenis_pertanian = $("#txt_jenis_pertanian").val();
		var luas_jumlah = $("#txt_luas_jumlah").val();
		var keterangan = $("#txt_keterangan").val();
		var uraian = $("#txt_uraian").val();
		...
		if (id == "" || kode_lahan == "" || jenis_pertanian == "" || luas_jumlah == "" || keterangan == "" || uraian == "" || tahun == "" || id_des == "" || id_kec == "" || id_tkr_kode_ipwdes == "") {
			swal({
				title: 'Tambah Gagal',
			...
			success: function(x) {
				...
				if (y == 1) {
					swal({
						...
						text: 'Data Pertanian Desa Berhasil di Tambahkan',
						icon: 'success'
					}).then((Refreshh) => {
						refresh();
						tabel.ajax.reload(null, false);
			...
			success: function(x) {
				...
				if (y == 1) {
					swal({
						...
						text: 'Data Pertanian Desa Berhasil di Update',
						icon: 'success'
					}).then((Refreshh) => {
						refresh();
						tabel.ajax.reload(null, false);
					...
					success: function(x) {
						...
						if (y == 1) {
							swal({
								...
								text: 'Data Pertanian Desa Berhasil di Hapus',
								icon: 'success'
							}).then((Refreshh) => {
								refresh();
								tabel.ajax.reload(null, false);
	...
	function filter(el) {
		...
		$.ajax({
			...
			success: function(x) {
				...
				if (xx[0] == 1) {
					$("#txtid").val(xx[1]);
					$("#txt_kode_lahan").val(xx[2]);
					$("#txt_jenis_pertanian").val(xx[3]);
					$("#txt_luas_jumlah").val(xx[4]);
