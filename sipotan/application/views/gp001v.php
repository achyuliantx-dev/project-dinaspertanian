<div class="page-header">
	<h1 class="page-title">Pengelolaan Data Gapoktan</h1>
			...
			<div class="panel-body">
				<div class="form-row">
                     <div class="form-group col-md-12">
						<label class="form-control-label">ID Gapoktan*</label>
...
<script>
	...
	function tambah(){
        ...
        if(id == "" || nama == "" || tgl == "" || no == ""|| stat == "" || alamat == "" || des == ""|| telp == "" || email == "" ){
        ...
        $.ajax({
            ...
            method: "POST",
            data: {id: id, nama: nama, tgl: tgl, no: no, stat: stat, alamat: alamat, des: des, telp: telp, email: email},
            cache: "false",
            success: function(x){
				swal.close();
				var y = atob(x);
                if(y == 1){
                    swal({
						...
						text: 'Data Gapoktan Berhasil di Tambahkan',
						icon: 'success'
					}).then((Refreshh)=>{
						refresh();
						tabel.ajax.reload(null, false);
            ...
            success: function(x){
                ...
                if(y == 1){
                    swal({
						...
						text: 'Data Gapoktan Berhasil di Update',
						icon: 'success'
					}).then((Refreshh)=>{
						refresh();
						tabel.ajax.reload(null, false);
					...
					success: function(x){
						...
						if(y == 1){
							swal({
								...
								text: 'Data Gapoktan Berhasil di Hapus',
								icon: 'success'
							}).then((Refreshh)=>{
								refresh();
								tabel.ajax.reload(null, false);
