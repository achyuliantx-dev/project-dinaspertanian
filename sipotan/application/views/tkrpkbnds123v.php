<div class="page-header">
	<h1 class="page-title">Pengelolaan Data Perkebunan Desa</h1>
			...
			<div class="panel-body">
				<div class="form-row">
					<div class="form-group col-md-12">
						<label class="form-control-label">ID Perkebunan Desa*</label>
					...
					<div class="form-group col-md-12 jedaobyek">
						...
						<input type="text" class="form-control khusus_abjad jedaobyek" id="txt_luas_area" placeholder="Masukkan Alamat" autocomplete="off">
					</div>
					<div class="form-group col-md-12 jedaobyek">
						<label class="form-control-label">Jumlah Pohon*</label>
						<input type="text" class="form-control khusus_abjad jedaobyek" id="txt_jumlah_pohon" placeholder="Masukkan Alamat" autocomplete="off">
					</div>
					<div class="form-group col-md-12 jedaobyek">
						<label class="form-control-label">Tahun*</label>
						<input type="text" class="form-control khusus_abjad jedaobyek" id="txt_tahun" placeholder="Masukkan Telepon" autocomplete="off">
					</div>
					<div class="form-group col-md-12 jedaobyek">
...
<script>
	...
	function tambah() {
		...
		var luas_area = $("#txt_luas_area").val();
		var jumlah_pohon = $("#txt_jumlah_pohon").val();
		var tahun = $("#txt_tahun").val();
		var des = $("#txt_id_des").val();
		var kec = $("#txt_id_kec").val();
		var ipwdes = $("#txt_id_ipwdes").val();

		if (id == "" || jenis_tanaman == "" || luas_area == "" || jumlah_pohon == "" || tahun == "" || des == "" || kec == "" || ipwdes == "") {
			swal({
				title: 'Tambah Gagal',
			...
			success: function(x) {
				...
				if (y == 1) {
					swal({
						...
						text: 'Data Perkebunan Desa Berhasil di Tambahkan',
						icon: 'success'
					}).then((Refreshh) => {
						refresh();
						tabel.ajax.reload(null, false);
			...
			success: function(x) {
				...
				if (y == 1) {
					swal({
						...
						text: 'Data Perkebunan Desa Berhasil di Update',
						icon: 'success'
					}).then((Refreshh) => {
						refresh();
						tabel.ajax.reload(null, false);
					...
					success: function(x) {
						...
						if (y == 1) {
							swal({
								...
								text: 'Data Perkebunan Desa Berhasil di Hapus',
								icon: 'success'
							}).then((Refreshh) => {
								refresh();
								tabel.ajax.reload(null, false);
		...
		$.ajax({
			...
			success: function(x) {
				...
				if (xx[0] == 1) {
					...
					$("#txt_luas_area").val(xx[3]);
					$("#txt_jumlah_pohon").val(xx[4]);
					$("#txt_tahun").val(xx[5]);
					$("#txt_id_des").val(xx[6]).change();
					$("#txt_id_kec").val(xx[7]).change();
					$("#txt_id_ipwdes").val(xx[8]).change();
